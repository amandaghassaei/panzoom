...
function createPanZoom(domElement, options) {
    ...
    function onTouch(e) {
        ...
        if (e.touches.length === 2) {
            // Handle pan.
            handleSingleFingerTouch(e, e.touches[0]);
    ...
    function onMouseDown(e) {
        ...
        // For IE (older versions), right click is button == 2
        // For modern browsers (Chrome, Firefox, Edge), right click is button == 2
        // Note: Firefox used to report left=0, middle=1, right=2 — still true.
